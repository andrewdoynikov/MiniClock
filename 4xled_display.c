...
{
  unsigned char ch;
  PORT(DIGIT_1) &= ~DIGIT_1_LINE;       // гасим все разр€ды
  PORT(DIGIT_2) &= ~DIGIT_2_LINE;       // гасим все разр€ды
  PORT(DIGIT_3) &= ~DIGIT_3_LINE;       // гасим все разр€ды
  PORT(DIGIT_4) &= ~DIGIT_4_LINE;       // гасим все разр€ды
  ...
  switch(ind_count) {
    case 0:
      PORT(DIGIT_1) |= DIGIT_1_LINE;    // включаем разр€д
    break;
    case 1:
      PORT(DIGIT_2) |= DIGIT_2_LINE;    // включаем разр€д
    break;
    case 2:
      PORT(DIGIT_3) |= DIGIT_3_LINE;    // включаем разр€д
    break;
    case 3:
      PORT(DIGIT_4) |= DIGIT_4_LINE;    // включаем разр€д
    break;
  }
  ind_count++;
